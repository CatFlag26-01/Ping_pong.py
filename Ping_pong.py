...
class GameSprite(sprite.Sprite):
    def __init__(self, player_image, player_x, player_y, player_speed, wight, height):
        super().__init__()
        self.image = transform.scale(image.load(player_image), (wight, height)) #es decir, 55,55 - parametros
...
#banderas responables por el estado del juego
game = True
finish = False
clock = time.Clock()
FPS = 60

#creando pelotas y paletas
